#ifndef __REACH_VOLUME_IMPORTER__
#define __REACH_VOLUME_IMPORTER__
...
public:
    ...
    // Stores the ID and modality of a DICOM series. The modality will be either "CT" or "MR". The
    // directory is the containing directory of the series.
    struct SeriesID
    {
        std::string id;
        std::string modality;
    ...
    void importVolume(const char* directory);
    
    /** Load a specific series. */
    void importVolume(SeriesID series);
};

#endif // __REACH_VOLUME_IMPORTER__
